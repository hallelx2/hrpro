          ...
          <TabsContent value="job-seeker">
            <Card className="shadow-lg">
              <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-base">Access your profile, job applications, and matches</CardDescription>
              </CardHeader>
              <form onSubmit={(e) => handleSubmit(e, "job-seeker")}>
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="js-remember" className="h-5 w-5" />
                    <label
                      htmlFor="js-remember"
          ...
          <TabsContent value="recruiter">
            <Card className="shadow-lg">
              <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-base">Access your organization dashboard and recruitment tools</CardDescription>
              </CardHeader>
              <form onSubmit={(e) => handleSubmit(e, "recruiter")}>
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="rec-remember" className="h-5 w-5" />
                    <label
